...
import 'package:eschool/cubits/deleteLeaveCubit.dart';
...
import 'package:eschool/ui/screens/leave/widgets/leaveDetailsBottomsheetContainer.dart';
import 'package:eschool/ui/styles/colors.dart';
import 'package:eschool/ui/widgets/confirmDeleteDialog.dart';
...
class LeaveContainer extends StatelessWidget {
  final Leave leave;
  final int index;
  const LeaveContainer({super.key, required this.leave, required this.index});
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      color: leave.statusColor, fontWeight: FontWeight.w600,),
                ),
              ),
            ],
          ),
                        ...
                        return InkWell(
                          onTap: () {
                            ...
                            showDialog<bool>(
                                ...
                                .then((value) {
                              if (value != null && value) {
                                context.read<DeleteLeaveCubit>().deleteLeave(
                                    leaveId: leave.id,
                                    isParent:
