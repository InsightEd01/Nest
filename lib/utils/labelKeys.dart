...
const String pleaseSelectAllElectiveSubjectsKey = "pleaseSelectAllElectiveSubjects";
...
const String assignmentSubmissionDisclaimerKey = "assignmentSubmissionDisclaimer";
...
const String quitExamDisclaimerKey = "quitExamDisclaimer";
...
const String allowStoragePermissionToContinueKey = "allowStoragePermissionToContinue";
...
const String noChatUsersKey = "noTeachersToChatWith";
...
const String subjectTeacherKey = "subjectTeacher";
...
const String teacherOfKey = "teacherOf";
...
const String upcomingExamsKey = "upcomingExams";
...
const String feePaymentDueKey = "feePaymentDue";
const String youCanContinueLearningAfterPayingTheFeesKey = "youCanContinueLearningAfterPayingTheFees";
const String askParentOrGuardianToPayFeesKey = "askParentOrGuardianToPayFees";
const String payFeesYourselfKey = "payFeesYourself";
const String weHaveAskedYourParentOrGuardianToPayTheFeesKey = "weHaveAskedYourParentOrGuardianToPayTheFees";
const String downloadFeesReceiptKey = "downloadFeesReceipt";
const String reCheckPaymentStatusKey = "reCheckPaymentStatus";

const String submitAssignmentKey = "submitAssignment";
const String textSubmissionKey = "textSubmission";
const String pleaseAddAtleastOneFileOrTextToSubmitKey = "pleaseAddAtleastOneFileOrTextToSubmit";
const String olderMessagesThenKey = "olderMessagesThen";
const String daysWillBeDeletedAutomaticallyKey = "daysWillBeDeletedAutomatically";

const String allKey = "all";
const String noHolidaysThisMonthKey = "noHolidaysThisMonth";
const String noEventsThisMonthKey = "noEventsThisMonth";
const String noExamsThisMonthKey = "noExamsThisMonth";

const String noSubjectsKey = "noSubjects";

const String feePaymentKey = "feePayment";
const String doNotPressBackWhilePaymentAndDoubleTapBackButtonToExitKey = "doNotPressBackWhilePaymentAndDoubleTapBackButtonToExit";
...
const String pickValidDateRangeWithoutHolidaysKey = "pickValidDateRangeWithoutHolidays";
...
const String filterByStatusKey = "filterByStatus";
...
const String leaveRequestsKey = "leaveRequests";
const String attachmentsKey = "attachments";
const String addMultipleAttachmentsKey = "addMultipleAttachments";

const String deleteDialogTitleKey = "deleteDialogTitle";
const String deleteDialogMessageKey = "deleteDialogMessage";

const String paymentOptionsKey = "paymentOptions";
const String noPaymentOptionsAvlKey = "noPaymentOptionsAvl";
