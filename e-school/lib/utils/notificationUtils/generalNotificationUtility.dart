...
class NotificationUtility {
  ...
  static String feePaymentDueType = "fees-due";
  ...
  static void _onTapNotificationScreenNavigateCallback(
    ...
    } else if (notificationType == feePaymentDueType) {
      UiUtils.rootNavigatorKey.currentState?.pushNamed(
        Routes.feesDetails,
        arguments: {"childId": data['child_id']},
      );
    ...
    if (image == null) {
      await AwesomeNotifications().createNotification(
        content: NotificationContent(
          ...
          locked: !dimissable,
          wakeUpScreen: true,
          payload: {"type": type}..addAll(message.data.cast<String, String?>()),
          channelKey: notificationChannelKey,
