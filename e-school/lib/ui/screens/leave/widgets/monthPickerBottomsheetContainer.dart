...
class MonthPickerBottomsheetContainer extends StatelessWidget {
  ...
  const MonthPickerBottomsheetContainer({super.key, required this.monthList, required this.selectedMonth});
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              Expanded(
                                child: Text(
                                  UiUtils.getTranslatedLabel(context, monthList[index].nameKey),
                              ...
                              CustomRadioContainer(isSelected: selectedMonth == monthList[index]),
                            ],
                          ),
                        ),
                      ),
